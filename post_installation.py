...
def github_create_secret(secret_name: str, secret_value: str) -> None:
    ...
    url_public_key = (
        ...
        "/agrajag/actions/secrets/public-key"
    )
    ...
    if r.status_code == 200:
        ...
        url_secret = (
            ...
            f"Stephen-RA-King"
            f"/agrajag/actions/secrets/{secret_name}"
        )
...
def readthedocs_create() -> None:
    ...
    body_json = {
        "name": "agrajag",
        "repository": {
            "url": "https://github.com/stephen-ra-king/agrajag",
            "type": "git",
        },
        "homepage": "http://agrajag.readthedocs.io/",
...
def readthedocs_update() -> None:
    ...
    url = "https://readthedocs.org/api/v3/projects/agrajag/"
    header = {"Authorization": f"token {READTHEDOCS_TOKEN}"}
